...
class tileFeatureDataset(Dataset):
    def __init__(self, patient_ids, file_dir, label_dict, gene_name=["TP53"], multilabel=False):
    ...
    def __getitem__(self, idx):
        f = os.path.join(self.root_dir, self.patients[idx]+'.npy')
