README for archive unc.edu_BLCA.IlluminaHiSeq_RNASeqV2.Level_3.1.7.0

This file was automatically generated on 04/19/2013 using the TCGA DCC Archive Processing System.
...
with Bladder Urothelial Carcinoma. The data was produced by the University of North Carolina
(unc.edu) Cancer Genomic Characterization Center (CGCC) using the Illumina HiSeq 2000 RNA Sequencing
Version 2 analysis platform.

This archive is the 7th revision of the 1st archive and contains only Level 3
